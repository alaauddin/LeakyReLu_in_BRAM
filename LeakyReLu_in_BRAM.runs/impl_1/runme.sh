...
HD_PWD='C:/Users/User/ACTIVATION FUNCTION/LeakyReLu_in_BRAM/LeakyReLu_in_BRAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LeakyReLu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LeakyReLu.tcl -notrace
